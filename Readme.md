...
A research project investigating ownership protection and robustness of transformer-based language models against model-level attacks.

## Overview
This project explores a unified framework for protecting large language models through :
...
The framework investigates whether ownership information can remain reliable when a model undergoes common transformations such as pruning, noise injection, quantization, and parameter sign flipping.
